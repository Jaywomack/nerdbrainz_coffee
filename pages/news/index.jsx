              ...
              <div className="w-full lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <p className="leading-relaxed my-5 text-xl">
                    ...
                    food products with the best coffee in town. Bring some
                    friends down and enjoy the atmosphere and friendly
            ...
            <div className="container px-5 py-24 mx-auto">
              <div className="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <p className="leading-relaxed my-5 text-xl">
                    @ Nerd Brainz we deal in quality and customer happiness. Our
                    number one goal is to make great money doing what we love.
                    But there is only one way we get there, and that is treating
                    every customer like they mean something to us. Because they
                    do. We do not just want to build web sites and never talk to
                    the customer again.
                  </p>
                  <p className="leading-relaxed text-xl">
                    We want to bring success into our customers lives and help
                    them fix business intelligence mistakes and compound on the
                    things that they are already doing right. We want to bring
                    E-commerce solutions and business intelligence to every one
                    so that they can make the most of the resources they have
                    and we can all retire early.{" "}
                    <span className="text-custom-tan">
                      To buy this site template or find out about e-commerce and
                      business intelligence solutions. Drop us a line at{" "}
